...
public class MicroSimulation implements GLEventListener, KeyListener {
	...
	public void init(GLAutoDrawable drawable) {
		...
		// Read the world
		try {
			shader1 = sm.init("src/main/resources/spider", gl);
		...
		// Read the world
		try {
			particleShader = sm.init("src/main/resources/particle", gl);
		} catch (IOException e1) {
			e1.printStackTrace();
		}		
		...
		try {
			top.loadModelData("src/main/resources/CustomChipTextured.obj");
		...
		try {
			syringe.loadModelData("src/main/resources/S+T_Textured.obj");
		} catch (IOException ex) {
			Logger.getLogger(MicroSimulation.class.getName()).log(
					Level.SEVERE, null, ex);
		}
		...
		try {
			tower.loadModelData("src/main/resources/tower_textured_final.obj");
		} catch (IOException ex) {
			Logger.getLogger(MicroSimulation.class.getName()).log(
					Level.SEVERE, null, ex);
		}
		...
		try {
			yeast.loadModelData("src/main/resources/YeastTextured2.obj");
		} catch (IOException ex) {
			Logger.getLogger(MicroSimulation.class.getName()).log(
					Level.SEVERE, null, ex);
		}
		...
		try {
			water.loadModelData("src/main/resources/WaterTexturedSheet.obj");
		} catch (IOException ex) {
			Logger.getLogger(MicroSimulation.class.getName()).log(
					Level.SEVERE, null, ex);
		}
		
		woodTexture = setUp2DText(gl, "src/main/resources/Wood.jpg");
		chipTexture = setUp2DText(gl, "src/main/resources/chip_texture.png");
		yeastTexture = setUp2DText(gl, "src/main/resources/YeastTexture.png");
		waterTexture = setUp2DText(gl, "src/main/resources/WaterTexture.jpg");
		saltWaterTexture = setUp2DText(gl, "src/main/resources/SaltWaterTexture.png");
		plasticTexture = setUp2DText(gl, "src/main/resources/Plastic.jpeg");
